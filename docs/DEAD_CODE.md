...
| DRF + `/api-token-auth/` | **Kept installed, URL gated** | Authtoken tables may already exist; endpoint off unless `DJANGO_ENABLE_TOKEN_AUTH=True`. Mobile uses `/api/v1/` JWT. See [API.md](API.md). |
